...
class Appli(tk.Tk):
    ...
    def creer_widgets(self):
        ...
        self.canv = tk.Canvas(self, bg="cyan", height=self.height,width=self.width)
    ...
    def submit(self):
        ...
        if self.genome_use in os.listdir('./data/genomes') and self.protein_use in module_vraidevrai.recup_prot(self.genome_use):
            ...
            thread = Thread(target = module_vraidevrai.main(self.genome_use,self.protein_use,self.os_use))
            thread.start() 
